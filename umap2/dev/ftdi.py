...
class USBFtdiVendor(USBVendor):
    ...
    def __init__(self, app):
        super(USBFtdiVendor, self).__init__(app)
...
class USBFtdiInterface(USBInterface):
    ...
    def __init__(self, app, interface_number):
    ...
    def handle_data_available(self, data):
        ...
        st = st.replace(b'\r', b'\r\n')
        reply = b'\x01\x00' + st
        self.app.send_on_endpoint(3, reply)
        ...
        super(USBFtdiDevice, self).__init__(
            ...
            configurations=[
                USBConfiguration(
                    ...
                    string="FTDI",
                    interfaces=[
                        USBFtdiInterface(app, 0)
                    ],
                    attributes=USBConfiguration.ATTR_BASE,
                    max_power=0x2d,
                )
            ],
            device_vendor=USBFtdiVendor(app=app)
        )
